...
func TestScan(t *testing.T) {
	...
	tweet1 := tweet{User: "quorumsco", Message: "Welcome to Golang and Elasticsearch."}
	tweet2 := tweet{User: "quorumsco", Message: "Another unrelated topic."}
...
func TestScanWithSort(t *testing.T) {
	...
	tweet1 := tweet{User: "quorumsco", Message: "Welcome to Golang and Elasticsearch.", Retweets: 4}
	tweet2 := tweet{User: "quorumsco", Message: "Another unrelated topic.", Retweets: 10}
...
func TestScanWithSearchSource(t *testing.T) {
	...
	src := NewSearchSource().
		Query(NewTermQuery("user", "quorumsco")).
...
func TestScanWithQuery(t *testing.T) {
	...
	// Return tweets from quorumsco only
	termQuery := NewTermQuery("user", "quorumsco")
