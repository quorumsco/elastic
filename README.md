...
This is a slightly modified version of elastic.v2 from olivere/elastic to work with url aliases

Elastic is an [Elasticsearch](http://www.elasticsearch.org/) client for the
[Go](http://www.golang.org/) programming language.

[![Build Status](https://travis-ci.org/quorumsco/elastic.svg?branch=release-branch.v3)](https://travis-ci.org/quorumsco/elastic)
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/quorumsco/elastic)
[![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/quorumsco/elastic/master/LICENSE)

See the [wiki](https://github.com/quorumsco/elastic/wiki) for additional information about Elastic.


## Releases

**Notice that the master branch always refers to the latest version of Elastic. If you want to use stable versions of Elastic, you should use the packages released via [github.com](https://github.com).**

Here's the version matrix:

Elasticsearch version | Elastic version -| Package URL
----------------------|------------------|------------
2.x                   | 3.0              | [`github.com/quorumsco/elastic.v3`](https://github.com/quorumsco/elastic.v3) ([source](https://github.com/quorumsco/elastic/tree/release-branch.v3) [doc](http://godoc.org/github.com/quorumsco/elastic.v3))
1.x                   | 2.0              | [`github.com/quorumsco/elastic`](https://github.com/quorumsco/elastic) ([source](https://github.com/quorumsco/elastic/tree/release-branch) [doc](http://godoc.org/github.com/quorumsco/elastic))
0.9-1.3               | 1.0              | [`github.com/quorumsco/elastic.v1`](https://github.com/quorumsco/elastic.v1) ([source](https://github.com/quorumsco/elastic/tree/release-branch.v1) [doc](http://godoc.org/github.com/quorumsco/elastic.v1))
...
```sh
$ go get github.com/quorumsco/elastic
```

Then you use it via the following import path:

```go
import "github.com/quorumsco/elastic"
```
...
Notice that there are a lot of [breaking changes in Elasticsearch 2.0](https://www.elastic.co/guide/en/elasticsearch/reference/2.0/breaking-changes-2.0.html) and we used this as an opportunity to [clean up and refactor Elastic as well](https://github.com/quorumsco/elastic/blob/release-branch.v3/CHANGELOG-3.0.md).

### Elastic 2.0

Elastic 2.0 targets Elasticsearch 1.x and published via [`github.com/quorumsco/elastic`](https://github.com/quorumsco/elastic).
...
See the [.travis.yml](https://github.com/quorumsco/elastic/blob/master/.travis.yml)
file for the exact matrix and [Travis](https://travis-ci.org/quorumsco/elastic)
for the results.
...
tweet := Tweet{User: "quorumsco", Message: "Take Five"}
_, err = client.Index().
    Index("twitter").
    Type("tweet").
    Id("1").
...
termQuery := elastic.NewTermQuery("user", "quorumsco")
...
See the [wiki](https://github.com/quorumsco/elastic/wiki) for more details.
...
Read [the contribution guidelines](https://github.com/quorumsco/elastic/blob/master/CONTRIBUTING.md).
...
MIT-LICENSE. See [LICENSE](http://quorumsco.mit-license.org/)
